...
$(document).ready(function () {
  function animateElement(element, zoomIn) {
      if (zoomIn) {
          $(element).addClass("animate__animated animate__zoomIn");
          $(element).removeClass("animate__zoomOut");
      } else {
          $(element).addClass("animate__animated animate__zoomOut");
          $(element).removeClass("animate__zoomIn");
      }
  }

  // home cat page anim
  $(".categories_right").waypoint({
      handler: function (direction) {
          if (direction === 'down') {
              animateElement(this.element, true);
          } else {
              animateElement(this.element, false);
          }
      },
      offset: "55%"
  });
